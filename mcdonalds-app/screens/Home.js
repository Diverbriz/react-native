...
function renderTrendingShoes(item, index){
  ...
  return(
    <TouchableOpacity style={{height: 240, width: 180, justifyContent: 'center', marginHorizontal: SIZES.base , ...trendingStyle}} 
    onPress={() => {
  ...
  return(
    selectedItem.sizes.map((item, index) => {
      return (
        ...
        >
          <Text style = {{color: selectedItem.sizes[index] == selectedSize ? COLORS.black : COLORS.white}}>{item} </Text>
        </TouchableOpacity>
      )
    })
  )
  ...
  return (
    <View style={styles.container}>
     ...
     <View style={{flex: 1, paddingBottom: SIZES.padding, }}>
      ...
      {/*Modal window*/}
     {selectedItem &&
      <Modal style={{width: 240, height: 240, backgroundColor: "#000"}}
      animationType="slide"
                    transparent={true}
      ...
      <TouchableOpacity
       ...
       <View style={{justifyContent: 'center', width: '96%', marginLeft: '2%', backgroundColor: selectedItem.bgColor}}>
      ...
      <View style={{flexDirection: 'row', marginTop: SIZES.radius, marginHorizontal: SIZES.padding}}>
        <View>
         <Text style={{color: COLORS.white, ...FONTS.h3}}>Select Size </Text>
        </View>
        <View style={{flex: 1, flexDirection: 'row', flexWrap: 'wrap', marginLeft: SIZES.radius}}>
            {renderShoesSize()}
        </View>
      </View>
      <TouchableOpacity
      ...
      >
        <Text
        style= {{color: COLORS.white, ...FONTS.largeTitleBold}}
        >Add to Bag</Text> 
      </TouchableOpacity>
      </View>
